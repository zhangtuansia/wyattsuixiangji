...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '508dfe93d396441fa6256a002312dd06',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个AI产品经理, Hi，我是Wyatt,欢迎来到我的space🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wyatt的随想集', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的 AI 产品经理', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.aipm.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yangziheng54@gmail.com', // 邮箱地址 例如mail@tangly1024.com
